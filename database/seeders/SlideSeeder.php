...
class SlideSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $slides = [
            [
                'title' => 'Nord Electro 7',
                'caption_en' => 'The Nord Electro 7 elevates the Electro series with a powerful new Synth Section, dedicated per-section effects and a refined panel design with a high-resolution color display.',
                'caption_de' => 'Das Nord Electro 7 bringt die Electro-Serie auf ein neues Level und punktet mit einer starken neuen Synth-Sektion,  speziellen Effekten für jede Sektion und einem coolen Panel-Design mit hochauflösenden Farbdisplay.',
                'caption_fr' => 'Le Nord Electro 7 élève la série Electro grâce à une nouvelle section Synth puissante, des effets dédiés par section et un design de panneau raffiné avec un écran couleur haute résolution.',
                'caption_nl' => 'De Nord Electro 7 tilt de Electro-serie naar een hoger niveau met een krachtige nieuwe Synth-sectie, speciale effecten per sectie en een verfijnd paneelontwerp met een kleurendisplay met hoge resolutie.',
                'caption_pl' => 'Nord Electro 7 wzbogaca serię Electro o nową, potężną sekcję syntezatora, osobne efekty dla każdej sekcji oraz udoskonalony panel z kolorowym wyświetlaczem o wysokiej rozdzielczości.',
                'background' => 'https://media.sound-service.eu/images/slider/Nord%20Electro7%20Shop%20Slider.jpg',
                'video' => 'https://www.youtube.com/watch?v=p-2Tnuk7MsQ',
                'link' => '/nord-keyboards/nord-electro-7-61',
                'order' => 0,
                'active' => true,
            ],
            [
